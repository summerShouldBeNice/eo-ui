<template>
  <div id="personal-todo">
    ...
    <div class="func-button-list">
      <el-button type="primary" plain @click="showAddInput">添加待办</el-button>
      <el-input v-model="input" placeholder="add todo event" class="add-input" v-show="addInputVisible"/>
      <el-button type="primary" plain @click="removeTodo">删除待办</el-button>
      <el-button type="primary" plain @click="accomplishTodo">完成待办</el-button>
    </div>
